...
// Fix: Use named imports for select and range from d3 to resolve property existence errors
...
const SyncTimeline: React.FC<SyncTimelineProps> = ({ tasks }) => {
  ...
  useEffect(() => {
    ...
    // Fix: Use the imported select function directly
    ...
    svg.append("g")
      .attr("class", "grid")
      .selectAll("line")
      // Fix: Use the imported range function directly
